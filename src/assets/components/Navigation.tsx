...
const Navigation = () => {
  ...
  const handleSelect = (path: string) => {
    navigate(path);
    setSearchQuery(''); // Kosongkan search setelah navigasi
    ...
    return ( 
      ...
      <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
          ...
          <div className="z-50 hidden my-4 text-base list-none divide-y divide-gray-100 rounded-lg shadow-sm bg-white" id="language-dropdown-menu">
            <ul className="py-2 font-medium" role="none">
              ...
              <li>
                <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                  <div className="inline-flex items-center">
                    <img className="h-3.5 w-3.5 rounded-full me-2" src="https://www.worldatlas.com/r/w1200-h701-c1200x701/upload/9f/69/0a/id-flag.jpg" alt="IND"/>
                    Indonesia
                  </div>
                </a>
              </li>
      ...
      <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 md:mt-0 mt-3" id="navbar-language">
        <div className="flex md:order-2">
        <button type="button" aria-expanded="false" className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1">
