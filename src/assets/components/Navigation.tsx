          ...
          <div className="flex md:order-2">
            <div className="relative w-full md:w-auto">
              ...
              <input
                ...
                className="block w-full md:w-96 p-2 ps-10 text-sm border rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Cari..."
                autoComplete="off"
              />
